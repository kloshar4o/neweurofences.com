...
class ZohoClient
{
    ...
    private $_baseUrl = 'inventory.zoho.eu/api/v1';
    private $_curlObject;
     ...
     * @throws \Exception
     */
    public function retrieveContactPersons($contact_id = null, array $filters = [])
    {
        return $this->curlRequest("/contacts/{$contact_id}/contactpersons", 'GET', $filters);
    }

    /**
     * @param string $contact_person_id contact id to update
     * @param array $params
     * @return \stdClass
     * @see https://www.zoho.com/inventory/api/v1/#update-an-contact
     * @throws \Exception
     */
    public function updateContactPerson($contact_person_id, array $params = [])
    {
        return $this->curlRequest("/contacts/contactpersons/{$contact_person_id}", 'PUT', ['JSONString' => json_encode($params)]);
    }
