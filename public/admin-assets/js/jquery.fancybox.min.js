...
!function (t, e, n, o) {
		...
		init: function () {
			...
			if (n = r.firstRun = null === r.firstRun, s = i = t = parseInt(t, 10), a = !!r.current && r.current.opts.loop, !r.isAnimating && (s != r.currIndex || n)) {
				if (r.group.length > 1 && a) {
					s %= r.group.length, s = s < 0 ? r.group.length + s : s, 2 == r.group.length ? i = t - r.currIndex + r.currPos : (i = s - r.currIndex + r.currPos, Math.abs(r.currPos - (i + r.group.length)) < Math.abs(r.currPos - i) ? i += r.group.length : Math.abs(r.currPos - (i - r.group.length)) < Math.abs(r.currPos - i) && (i -= r.group.length));
				} else if (!r.group[s]) {
			...
			if (o = t % i.group.length, o = o < 0 ? i.group.length + o : o, !i.slides[t] && i.group[o]) {
				if (i.opts.loop && i.group.length > 2) {
					for (var a in i.slides)if (i.slides[a].index === o) {
						return s = i.slides[a], s.pos = t, i.slides[t] = s, delete i.slides[a], i.updateSlide(s), s;
					}
				}
		...
		animate: function (t, e, s, i, a, r) {
			var c, l, d, p = this, h = null, f = 0, g = function () {
				...
				if (c = [], l = 0, t.length && t.data("animateID") === d) {
					if (n = n || Date.now(), h && (l = n - h), h = n, f += l, f >= i) {
						return void g();
					}
	...
	var o = function () {
		...
		for (var e = !1; ;) {
			...
			if (t = t.parent(), !t.length || t.hasClass("fancybox-slider") || t.is("body")) {
				break
			}
		}
		return e
	...
	l.prototype.destroy = function () {
		...
		if (s -= t.$wrap.offset().left, i -= t.$wrap.offset().top, e.SlideShow && e.SlideShow.isActive && e.SlideShow.stop(), !n.fancybox.isTouch) {
		...
		if (t.tapped) {
			if (clearTimeout(t.tapped), t.tapped = null, Math.abs(s - t.x) > 50 || Math.abs(i - t.y) > 50 || !o.isMoved) {
				return this;
			}
