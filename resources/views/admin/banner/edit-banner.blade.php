...
@section('content')
    ...
    <div class="form-content">
        @if($groupSubRelations->new == 1)
            @include('admin.list-elements', [
                'actions' => [
                    ...
                    trans('variables.edit_element') => urlForFunctionLanguage($lang, str_slug($banner_without_lang->name).'/edititem/'.$banner_without_lang->banner_id.'/'.$edited_lang_id)
                ]
            ])
        @else
            @include('admin.list-elements', [
        ...
        <div class="form-page">
            ...
            <div class="form-head">
                <span>{{trans('variables.edit_element')}} "{{$banner->name or ''}}"</span>
            </div>
            <div class="form-body">
                <form class="form" method="POST" action="{{ urlForLanguage($lang, 'save/'.$banner_without_lang->banner_id.'/'.$edited_lang_id) }}" id="edit-form" enctype="multipart/form-data" data-parent-url="{{$url_for_active_elem}}">
                    ...
                    <div class="fields-row">
                        ...
                        <div class="input-wrap">
                            <input name="name" id="name" value="{{$banner->name or ''}}">
                        </div>
                    </div>
                    <div class="fields-row">
                        <div class="label-wrap">
                        ...
                        <div class="input-wrap">
                            <textarea name="body" id="body" data-type="ckeditor">{{$banner->body or ''}}</textarea>
                        </div>
                    </div>
                    <div class="fields-row">
                    ...
                    <div class="fields-row">
                        ...
                        <div class="input-wrap">
                            <input name="link" id="link" value="{{$banner_id->link or ''}}">
                        </div>
                    </div>
