...
@section('content')
    ...
    <div class="form-content">
        ...
        <div class="form-page" ng-app="" ng-init="ral = '{{$color->ral or ''}}'; hex = '{{$color->hex or ''}}'; name = '{{$color->name or ''}}'; ">
            ...
            <div class="form-body altehForm">
                ...
                <form class="form" method="POST" action="{{ urlForLanguage($lang, 'save/'.$color->id.'/'.$edited_lang_id) }}" id="edit-form" enctype="multipart/form-data">
                    <h1>{{trans('variables.edit_element')}} "{{$color->name or ''}}"</h1>
                    ...
                    <div class="input-wrap">
                        <input name="ral" id="ral" ng-model="ral" ng-value="'{{$color->ral or ''}}'" required>
                    </div>
                    ...
                    <div class="input-wrap">
                        <input name="hex" id="hex" ng-model="hex" ng-value="'{{$color->hex or ''}}'" required>
                    </div>


                    <div class="label-wrap">
                        <label for="name">{{trans('variables.color')}}</label>
                    </div>
                    <div class="input-wrap">
                        <input name="name" id="name" ng-model="name" ng-value="'{{$color->name or ''}}'" required>
                    </div>
