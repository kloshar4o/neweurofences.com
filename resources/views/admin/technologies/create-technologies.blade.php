...
@section('content')
    ...
    <div class="form-content">
        @if($groupSubRelations->new == 1)
            @if(request()->segment(5) == '' || request()->segment(4) == 'createTechnologies')
        ...
        <div class="form-page">
            ...
            <div class="form-body">
                <form class="form" method="POST" action="{{ urlForLanguage($lang, 'savetechnologies') }}" id="add-form" enctype="multipart/form-data">
