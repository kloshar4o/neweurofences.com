...
@section('content')
    ...
    <div class="form-content">
        ...
        <div class="form-page">
            ...
            <div class="form-head">
                <span>{{trans('variables.edit_element')}} "{{$user->name or ''}}"</span>
            </div>
            <div class="form-body">
                <form class="form" method="POST" action="{{ urlForLanguage($lang, 'save/'.$user->id) }}" id="edit-form"
                            ...
                            <div class="input-wrap">
                                <select name="group-list" id="group-list" class="select2">
                                    @foreach($all_group as $one_group)
                                        <option value="{{$one_group->id}}" {{$group->id == $one_group->id ? 'selected' : ''}}>{{$one_group->name or ''}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="fields-row">
                        ...
                        <div class="input-wrap">
                            <input name="login" id="login" value="{{$user->login or ''}}" autocomplete="off">
                        </div>
                    </div>
                    <div class="fields-row">
                        <div class="label-wrap">
                        ...
                        <div class="input-wrap">
                            <input name="name" id="name" value="{{$user->name or ''}}" autocomplete="off">
                        </div>
                    </div>
                    <div class="fields-row">
                        <div class="label-wrap">
                    ...
                    <div class="fields-row">
                        ...
                        <div class="input-wrap">
                            <input id="update-date" value="{{$user->updated_at or ''}}" readonly>
                        </div>
                    </div>
                    <div class="fields-row">
